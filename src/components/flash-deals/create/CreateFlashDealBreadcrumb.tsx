type CreateFlashDealBreadcrumbProps = {
  onBack: () => void
}

function CreateFlashDealBreadcrumb({ onBack }: CreateFlashDealBreadcrumbProps) {
  return (
    <nav
    ...
    >
      ...
      <span className="text-slate-400">&gt;</span>
      <span className="truncate font-semibold text-slate-700">Create Flash Deal</span>
    </nav>
  )
}
