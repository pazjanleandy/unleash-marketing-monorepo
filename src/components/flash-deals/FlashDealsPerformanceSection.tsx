    ...
    <article className="rounded-none border-0 bg-transparent px-0 shadow-none sm:rounded-2xl sm:border sm:border-[#dbeafe] sm:bg-white sm:p-5 sm:shadow-[0_14px_30px_-28px_rgba(37,99,235,0.8)]">
      ...
      <div className="w-full overflow-hidden bg-transparent px-4 py-3 sm:hidden">
        <div className="mb-2.5 flex items-center justify-end px-0.5">
          ...
          <span className="ml-1 text-xs font-semibold text-slate-500">&harr;</span>
        </div>
        <div className="relative">
          ...
          {metrics.map((metric) => {
            ...
            return (
              <article
                key={metric.label}
                className="flex h-[122px] min-w-[170px] max-w-[170px] shrink-0 snap-start flex-col overflow-hidden rounded-xl border border-slate-200 bg-white p-3.5 shadow-sm"
              >
          ...
          <div className="pointer-events-none absolute inset-y-0 left-0 w-5 bg-gradient-to-r from-[#f8fafc] via-[#f8fafc]/90 to-transparent" />
          <div className="pointer-events-none absolute inset-y-0 right-0 w-8 bg-gradient-to-l from-[#f8fafc] via-[#f8fafc]/90 to-transparent" />
        </div>
